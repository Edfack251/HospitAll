...
<div class="bg-white p-4 sm:p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
        ...
        <a href="<?php echo App\Helpers\UrlHelper::url('users_create'); ?>"
                ...
                <?php foreach ($usuarios as $u): ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <span class="px-3 py-1 rounded-full text-xs font-semibold 
                                ...
                                switch (strtolower($u['rol_nombre'])) {
                                    ...
                                    case 'tecnico_laboratorio':
                                        ...
                                        break;
                                    case 'farmaceutico':
                                        echo 'bg-teal-100 text-teal-600';
                                        break;
                                    case 'paciente':
                        ...
                        <td class="py-4 text-right">
                            <a href="<?php echo App\Helpers\UrlHelper::url('users_edit'); ?>?id=<?php echo $u['id']; ?>"
