...
<!-- Sección Pendientes -->
<div id="tab-pendientes" class="tab-content glass-card p-4 sm:p-6 md:p-8 rounded-2xl shadow-sm">
                        ...
                        <td class="py-4">
                            <div class="flex space-x-2">
                                ...
                                <?php if ($o['archivo_pdf']): ?>
                                    <a href="<?php echo \App\Helpers\UrlHelper::url($o['archivo_pdf']); ?>" target="_blank"
