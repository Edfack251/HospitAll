...
<body class="h-screen flex items-center justify-center p-6">
    <div class="glass w-full max-w-lg p-8 rounded-2xl shadow-xl">
        ...
        <form action="<?php echo UrlHelper::url('api/auth/register'); ?>" method="POST" class="grid grid-cols-2 gap-4">
        ...
        <div class="mt-8 text-center text-sm text-[#6C757D]">
            ¿Ya tienes una cuenta? <a href="<?php echo UrlHelper::url('login'); ?>"
                class="text-[#007BFF] font-semibold hover:underline">Inicia
                sesión</a>
        </div>
    </div>
</body>
