...
// (Opcional) Si estuviéramos registrando políticas individuales más granulares:
// AuthorizationPolicy::authorize('view_billing_panel');
                ...
                <?php foreach ($facturas as $f): ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="py-3 px-2">
                            ...
                            <a href="billing_details.php?id=<?php echo $f['id']; ?>"
...
<div id="modalCreate" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-2xl p-8 w-full max-w-sm shadow-xl relative">
        ...
        <form action="api/billing_create_api.php" method="POST" class="space-y-4">
