...
if (!$prescripcion) {
    header("Location: pharmacy.php?error=not_found");
    exit();
}
...
<div class="max-w-4xl mx-auto">
    ...
    <form action="api/pharmacy_process_dispense.php" method="POST" class="space-y-6">
    ...
    <div class="glass-card p-10 rounded-2xl shadow-sm">
        ...
        <div class="flex justify-end space-x-4 mt-8 pt-6 border-t font-semibold">
            <a href="pharmacy.php" class="px-6 py-2 rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-50 transition">Cancelar</a>
            <button type="submit" 
